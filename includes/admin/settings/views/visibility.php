 ...
 * Loads the Location settings section in the plugin settings page.
 * 
...
/**
 * Retrieve the location settings fields from the MCWC_Admin_Settings class.
 * @var array $fields Array of location settings fields.
 * 
 */
$fields = MCWC_Admin_Settings::display_rules_field();
...
/**
 * Load the settings form template for the Location settings tab.
 */
wc_get_template(
	'fields/setting-forms.php',
	array(
		'title'   => 'Page Visibility Rules',   // Section title.
