<td colspan="2" style="padding:0;">
    <table class="mcwc-table mcwc-currency-by-country">
        <thead>
        <tr>
            <th><?php esc_html_e( 'Currency', 'multicurrency-for-woocommerce-pro' ) ?></th>
            <th><?php esc_html_e( 'Countries', 'multicurrency-for-woocommerce-pro' ) ?></th>
            <th class="mcwc-currency-by-country-action"><?php esc_html_e( 'Actions', 'multicurrency-for-woocommerce-pro' ) ?></th>
        </tr>
        </thead>
        <tbody>
        <?php
            ...
            <tr>
                ...
                <td>
                    <select multiple
                            ...
                            data-placeholder="<?php esc_attr_e( 'Please select countries', 'multicurrency-for-woocommerce-pro' ) ?>">
                ...
                <td>
                    <button class="mcwc-admin-button mcwc-select-all-countries">
                        <?php esc_html_e( 'Select all', 'multicurrency-for-woocommerce-pro' ); ?>
                    </button>
                    <button class="mcwc-admin-button mcwc-remove-all-countries">
                        <?php esc_html_e( 'Remove all', 'multicurrency-for-woocommerce-pro' ); ?>
                    </button>
                </td>
            </tr>
        <?php endforeach; ?>
